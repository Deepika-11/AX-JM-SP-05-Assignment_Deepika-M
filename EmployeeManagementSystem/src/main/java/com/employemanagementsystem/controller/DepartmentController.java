...
public class DepartmentController {
    ...
    public ResponseEntity<?> saveDepartmentDetails(@RequestBody Department department) {
        ...
        if (!departmentServiceImpl.saveDepartment(department)) {
            return new InvalidDepartmentIdException("Department is already found").handleDepartmentException();
        }
    ...
    public ResponseEntity<?> getDepartmentById(@PathVariable("id") int id) {
        ...
        if (department.isEmpty()) {
            return new InvalidDepartmentIdException("Department Id not found").handleDepartmentException();
        }
